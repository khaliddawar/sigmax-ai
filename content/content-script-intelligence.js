...
const SELECTORS = {
  ...
  'whatsapp': {
    message: 'div[class*="message-in"], div[class*="message-out"]',
    author: 'span[dir="auto"][class*="copyable-text"][data-pre-plain-text]',
    content: 'span[class*="selectable-text"] span, div[class*="copyable-text"] span',
...
function processMessage(messageElement) {
  ...
  if (!content || content.length < 3) return; // Only skip very short messages
